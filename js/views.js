...
const Views = {
  ...
  renderDashboard(container, data) {
    ...
    const categoryHours =
      analytics &&
      analytics.categoryHours &&
      typeof analytics.categoryHours === "object"
        ? analytics.categoryHours
        : {};
    ...
    setTimeout(() => {
      ...
      if (Object.keys(categoryHours).length > 0) {
        Charts.createCategoryChart("categoryChart", categoryHours);
      }
      
      // Start quote rotation (every 40 seconds)
      if (typeof Utils !== 'undefined' && Utils.startQuoteRotation) {
        Utils.startQuoteRotation();
      }
    }, 0);
  },
