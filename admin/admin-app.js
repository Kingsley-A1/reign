...
const AdminApp = {
  ...
  getAdminUser() {
    ...
    if (!userStr) {
      ...
      console.warn(
        "[DEV] Creating demo admin - this should not happen in production"
      );
      const demoAdmin = {
        id: "admin-1",
        name: "Super Admin",
  ...
  updateAdminInfo() {
    ...
    if (this.adminUser) {
      ...
      initialsEl.textContent =
        this.adminUser.initials || this.adminUser.name.charAt(0);
    }
  },
  ...
  renderDashboardContent(container, stats, health, recentLogs) {
    ...
    const streakLeaders =
      stats.streakLeaders || stats.engagement?.streakLeaders || 0;
    const tasksToday = stats.tasksToday || stats.content?.tasksToday || 0;
    const completionRate =
      stats.completionRate || stats.content?.completionRate || 0;
            ...
            <div class="dashboard-grid">
                ...
                <div class="dashboard-card">
                    ...
                    <div class="health-grid">
                        ...
                        <div class="health-item">
                            <div class="health-indicator ${
                              health.database === "connected" ? "" : "danger"
                            }"></div>
                      ...
                      recentLogs.length > 0
                        ...
                        <div class="activity-item">
                            <div class="activity-icon">
                                <i class="ph-bold ${this.getAuditIcon(
                                  log.action
                                )}"></i>
                            </div>
                            <div class="activity-content">
                                ...
                                <p class="activity-time">${this.formatTimeAgo(
                                  log.created_at
                                )}</p>
                            </div>
                        </div>
  ...
  renderUsersContent(container, users) {
    ...
    container.innerHTML = `
                ...
                <table class="admin-table">
                    ...
                    <tbody id="users-tbody">
                        ${paginatedUsers
                          .map(
                            (user) => `
                            <tr data-user-id="${user.id}" data-name="${(
                              user.name || ""
                            ).toLowerCase()}" data-role="${user.role}">
                                <td>
                                    <div class="user-cell">
                                ...
                                <td><span class="streak-badge">${
                                  user.streak || 0
                                } 🔥</span></td>
                                <td class="time-cell">${
                                  user.lastActive ||
                                  this.formatTimeAgo(user.last_login)
                                }</td>
                                <td>
                                    <div class="action-btns">
                                        <button onclick="AdminApp.viewUser('${
                                          user.id
                                        }')" title="View">
                                            <i class="ph-bold ph-eye"></i>
                                        </button>
                                        <button onclick="AdminApp.impersonateUser('${
                                          user.id
                                        }')" title="Impersonate">
                                            <i class="ph-bold ph-user-switch"></i>
                                        </button>
                                        <button onclick="AdminApp.suspendUser('${
                                          user.id
                                        }')" title="Suspend" class="danger">
      ...
      users.length
                    ...
                    <div class="pagination-controls">
                        <select class="pagination-select" onchange="AdminApp.setPerPage(this.value)">
                            <option value="10" ${
                              this.pagination.perPage === 10 ? "selected" : ""
                            }>10 per page</option>
                            <option value="25" ${
                              this.pagination.perPage === 25 ? "selected" : ""
                            }>25 per page</option>
                            <option value="50" ${
                              this.pagination.perPage === 50 ? "selected" : ""
                            }>50 per page</option>
                        </select>
                        <div class="pagination-buttons">
                            <button onclick="AdminApp.goToPage(1)" ${
                            ...
                            <button onclick="AdminApp.goToPage(${
                              this.pagination.currentPage - 1
                            })" ${
      ...
      this.pagination.currentPage >= totalPages ? "disabled" : ""
                            ...
                            <button onclick="AdminApp.goToPage(${totalPages})" ${
      this.pagination.currentPage >= totalPages ? "disabled" : ""
    }>
    ...
    container.innerHTML = `
            <div class="dashboard-card">
                ...
                <p style="color: #64748b; text-align: center; padding: 3rem;">
                    ...
                    <br><br>
                    <a href="/" style="color: var(--admin-accent);">Open Reign App →</a>
                </p>
            </div>
        `;
  },
            ...
            <div class="dashboard-card">
                ...
                <div class="settings-section">
                    ...
                    <div class="setting-row">
                        ...
                        <label class="toggle">
                            <input type="checkbox" id="setting-registration" ${
                ...
                <div class="settings-section">
                    ...
                    <div class="setting-row">
                        ...
                        <select id="setting-theme" class="settings-select">
                            <option value="king" ${
                              settings.defaultTheme === "king" ? "selected" : ""
                            }>King (Gold)</option>
                            <option value="queen" ${
                              settings.defaultTheme === "queen"
                                ? "selected"
                                : ""
                            }>Queen (Purple)</option>
                        </select>
                    ...
                    <div class="setting-row">
                        ...
                        <input type="number" id="setting-timeout" value="${
                          settings.sessionTimeout || 10
                        }" min="1" max="30" class="settings-input" style="width: 80px;">
                    </div>
                </div>
                ...
                <div class="settings-section">
                    ...
                    <div class="setting-row">
                        ...
                        <label class="toggle">
                            <input type="checkbox" id="setting-emails" ${
  ...
  saveSettings() {
    const settings = {
      ...
      maintenanceMode:
        document.getElementById("setting-maintenance")?.checked || false,
      allowRegistration:
        document.getElementById("setting-registration")?.checked !== false,
      defaultTheme: document.getElementById("setting-theme")?.value || "king",
      sessionTimeout:
        parseInt(document.getElementById("setting-timeout")?.value) || 10,
      emailNotifications:
        document.getElementById("setting-emails")?.checked !== false,
      pushNotifications:
                        ...
                        <div class="activity-item">
                          ...
                          log.type === "danger"
                            ...
                            <div class="activity-content">
                                ...
                                <p class="activity-time">${log.time} • ${
                          log.user
                        }</p>
                            </div>
                        </div>
    ...
    return [
      {
        ...
        text: "New user registered: sarah@email.com",
        time: "5 mins ago",
      },
      {
        icon: "ph-bold ph-check-circle",
        text: "John Doe completed 5 tasks",
        time: "12 mins ago",
      },
      {
        icon: "ph-bold ph-fire",
        text: "Jane Smith reached a 30-day streak!",
        time: "1 hour ago",
      },
      {
        icon: "ph-bold ph-book-open",
        text: "New course started: JavaScript Mastery",
        time: "2 hours ago",
      },
    ];
  },
  ...
  getMockAuditLog() {
    ...
    return [
      {
        icon: "ph-bold ph-user-switch",
        text: "Admin impersonated user: john@example.com",
        time: "10 mins ago",
        user: "Super Admin",
        type: "info",
      },
      {
        ...
        text: "User suspended: spam@bot.com",
        time: "1 hour ago",
        user: "Moderator",
        type: "danger",
      },
      ...
      user.status
                        ...
                        <div class="user-actions-section">
                            ...
                            <div class="action-buttons-grid">
                                ...
                                <button onclick="AdminApp.promoteUser('${
                                  user.id
                                }')" class="action-btn success">
                                    <i class="ph-bold ph-arrow-up"></i>
                                    Promote
                                </button>
                                <button onclick="AdminApp.resetPassword('${
                                  user.id
                                }')" class="action-btn warning">
                                    <i class="ph-bold ph-key"></i>
                                    Reset Password
                                </button>
                                <button onclick="AdminApp.sendEmailToUser('${
                                  user.id
                                ...
                                <button onclick="AdminApp.deleteUser('${
                                  user.id
  ...
  impersonateUser(userId) {
    ...
    if (user) {
      ...
      document
        .getElementById("impersonation-banner")
  ...
  async promoteUser(userId) {
    ...
    try {
      ...
      Utils.showToast(
        `${result.user.name} promoted to ${roleChoice}`,
        "success"
      );
  ...
  async deleteUser(userId) {
    ...
    try {
      ...
      Utils.showToast(
        `${result.deletedUser.name} has been permanently deleted`,
        "danger"
      );
      this.navigate("users"); // Refresh user list
    } catch (error) {
  ...
  exportUsers() {
    ...
    const csv = [
      ...
      ...users.map(
        (u) =>
          `${u.name},${u.email},${u.role},${u.status},${u.streak},${
            u.joinDate || ""
          },${u.location || ""}`
      ),
    ].join("\n");
